...
namespace Simtabi\UsernameWrangler\Factories;

use Illuminate\Support\Collection;
use Simtabi\UsernameWrangler\Contracts\SuggesterDriver;
use Simtabi\UsernameWrangler\Contracts\Suggester as SuggesterContract;
use Simtabi\UsernameWrangler\Exceptions\DriverNotFoundException;
